...
Ext.define('ExtThemeNeptune.layout.component.Dock', {
    ...
    noBorderClassTable: [
        0,                                      // TRBL
        Ext.BusCSSPrefix + 'noborder-l',       // 0001 = 1
        Ext.BusCSSPrefix + 'noborder-b',       // 0010 = 2
        Ext.BusCSSPrefix + 'noborder-bl',      // 0011 = 3
        Ext.BusCSSPrefix + 'noborder-r',       // 0100 = 4
        Ext.BusCSSPrefix + 'noborder-rl',      // 0101 = 5
        Ext.BusCSSPrefix + 'noborder-rb',      // 0110 = 6
        Ext.BusCSSPrefix + 'noborder-rbl',     // 0111 = 7
        Ext.BusCSSPrefix + 'noborder-t',       // 1000 = 8
        Ext.BusCSSPrefix + 'noborder-tl',      // 1001 = 9
        Ext.BusCSSPrefix + 'noborder-tb',      // 1010 = 10
        Ext.BusCSSPrefix + 'noborder-tbl',     // 1011 = 11
        Ext.BusCSSPrefix + 'noborder-tr',      // 1100 = 12
        Ext.BusCSSPrefix + 'noborder-trl',     // 1101 = 13
        Ext.BusCSSPrefix + 'noborder-trb',     // 1110 = 14
        Ext.BusCSSPrefix + 'noborder-trbl'     // 1111 = 15
    ],
